...
export const MOCK_RECIPES: InventoryRecipe[] = [
  // ── Jollof (serves 1 portion) ─────────────────────────────────────────────
  {
    ...
    ingredients: [
      { id: 1,  item_id: 5,  item: { id: 5,  sku: 'ITM-000005', name: 'Jollof Rice Parboiled',  base_unit: { id: 1, name: 'Kilogram', symbol: 'kg' } }, quantity: 0.22, unit: { id: 1, symbol: 'kg' } },
      { id: 2,  item_id: 6,  item: { id: 6,  sku: 'ITM-000006', name: 'Tomatoes (Fresh)',         base_unit: { id: 1, name: 'Kilogram', symbol: 'kg' } }, quantity: 0.08, unit: { id: 1, symbol: 'kg' } },
      { id: 3,  item_id: 7,  item: { id: 7,  sku: 'ITM-000007', name: 'Onions (Large)',           base_unit: { id: 1, name: 'Kilogram', symbol: 'kg' } }, quantity: 0.04, unit: { id: 1, symbol: 'kg' } },
      { id: 4,  item_id: 16, item: { id: 16, sku: 'ITM-000016', name: 'Scotch Bonnet Pepper',     base_unit: { id: 1, name: 'Kilogram', symbol: 'kg' } }, quantity: 0.01, unit: { id: 1, symbol: 'kg' } },
      { id: 5,  item_id: 9,  item: { id: 9,  sku: 'ITM-000009', name: 'Palm Oil',                 base_unit: { id: 3, name: 'Litre', symbol: 'L'  } }, quantity: 0.03, unit: { id: 3, symbol: 'L'  } },
      { id: 6,  item_id: 30, item: { id: 30, sku: 'ITM-000030', name: 'Seasoning Cubes (Maggi)',  base_unit: { id: 5, name: 'Piece', symbol: 'pc' } }, quantity: 2,    unit: { id: 5, symbol: 'pc' } },
      { id: 7,  item_id: 21, item: { id: 21, sku: 'ITM-000021', name: 'Cabbage (White)',           base_unit: { id: 1, name: 'Kilogram', symbol: 'kg' } }, quantity: 0.05, unit: { id: 1, symbol: 'kg' } },
      { id: 8,  item_id: 24, item: { id: 24, sku: 'ITM-000024', name: 'Mayonnaise',               base_unit: { id: 3, name: 'Litre', symbol: 'L'  } }, quantity: 0.02, unit: { id: 3, symbol: 'L'  } },
    ],
  },
  ...
  // ── Fried Rice ────────────────────────────────────────────────────────────
  {
    ...
    created_at: '2026-02-15T00:00:00Z', updated_at: '2026-03-01T00:00:00Z',
    ingredients: [
      { id: 9,  item_id: 4,  item: { id: 4,  sku: 'ITM-000004', name: 'Basmati Rice',             base_unit: { id: 1, name: 'Kilogram', symbol: 'kg' } }, quantity: 0.20, unit: { id: 1, symbol: 'kg' } },
      { id: 10, item_id: 31, item: { id: 31, sku: 'ITM-000031', name: 'Eggs',                     base_unit: { id: 5, name: 'Piece', symbol: 'pc' } }, quantity: 1,    unit: { id: 5, symbol: 'pc' } },
      { id: 11, item_id: 29, item: { id: 29, sku: 'ITM-000029', name: 'Mixed Vegetables (Frozen)',base_unit: { id: 1, name: 'Kilogram', symbol: 'kg' } }, quantity: 0.08, unit: { id: 1, symbol: 'kg' } },
      { id: 12, item_id: 23, item: { id: 23, sku: 'ITM-000023', name: 'Spring Onions',            base_unit: { id: 1, name: 'Kilogram', symbol: 'kg' } }, quantity: 0.02, unit: { id: 1, symbol: 'kg' } },
      { id: 13, item_id: 10, item: { id: 10, sku: 'ITM-000010', name: 'Soyabean Oil',             base_unit: { id: 3, name: 'Litre', symbol: 'L'  } }, quantity: 0.03, unit: { id: 3, symbol: 'L'  } },
      { id: 14, item_id: 30, item: { id: 30, sku: 'ITM-000030', name: 'Seasoning Cubes (Maggi)',  base_unit: { id: 5, name: 'Piece', symbol: 'pc' } }, quantity: 2,    unit: { id: 5, symbol: 'pc' } },
      { id: 15, item_id: 21, item: { id: 21, sku: 'ITM-000021', name: 'Cabbage (White)',           base_unit: { id: 1, name: 'Kilogram', symbol: 'kg' } }, quantity: 0.05, unit: { id: 1, symbol: 'kg' } },
      { id: 16, item_id: 24, item: { id: 24, sku: 'ITM-000024', name: 'Mayonnaise',               base_unit: { id: 3, name: 'Litre', symbol: 'L'  } }, quantity: 0.02, unit: { id: 3, symbol: 'L'  } },
    ],
  },
  ...
  // ── Noodles ───────────────────────────────────────────────────────────────
  {
    ...
    created_at: '2026-02-15T00:00:00Z', updated_at: '2026-03-01T00:00:00Z',
    ingredients: [
      { id: 17, item_id: 18, item: { id: 18, sku: 'ITM-000018', name: 'Indomie Noodles',          base_unit: { id: 7, name: 'Carton', symbol: 'ctn' } }, quantity: 2, unit: { id: 5, symbol: 'pc' } },
      { id: 18, item_id: 31, item: { id: 31, sku: 'ITM-000031', name: 'Eggs',                     base_unit: { id: 5, name: 'Piece', symbol: 'pc' } }, quantity: 1, unit: { id: 5, symbol: 'pc' } },
      { id: 19, item_id: 7,  item: { id: 7,  sku: 'ITM-000007', name: 'Onions (Large)',           base_unit: { id: 1, name: 'Kilogram', symbol: 'kg' } }, quantity: 0.03, unit: { id: 1, symbol: 'kg' } },
      { id: 20, item_id: 23, item: { id: 23, sku: 'ITM-000023', name: 'Spring Onions',            base_unit: { id: 1, name: 'Kilogram', symbol: 'kg' } }, quantity: 0.02, unit: { id: 1, symbol: 'kg' } },
      { id: 21, item_id: 10, item: { id: 10, sku: 'ITM-000010', name: 'Soyabean Oil',             base_unit: { id: 3, name: 'Litre', symbol: 'L'  } }, quantity: 0.02, unit: { id: 3, symbol: 'L'  } },
      { id: 22, item_id: 21, item: { id: 21, sku: 'ITM-000021', name: 'Cabbage (White)',           base_unit: { id: 1, name: 'Kilogram', symbol: 'kg' } }, quantity: 0.05, unit: { id: 1, symbol: 'kg' } },
      { id: 23, item_id: 24, item: { id: 24, sku: 'ITM-000024', name: 'Mayonnaise',               base_unit: { id: 3, name: 'Litre', symbol: 'L'  } }, quantity: 0.02, unit: { id: 3, symbol: 'L'  } },
    ],
  },
  ...
  // ── Banku + Grilled Tilapia ───────────────────────────────────────────────
  {
    ...
    created_at: '2026-02-15T00:00:00Z', updated_at: '2026-03-01T00:00:00Z',
    ingredients: [
      { id: 24, item_id: 19, item: { id: 19, sku: 'ITM-000019', name: 'Corn Dough (Fermented)',   base_unit: { id: 1, name: 'Kilogram', symbol: 'kg' } }, quantity: 0.25, unit: { id: 1, symbol: 'kg' } },
      { id: 25, item_id: 20, item: { id: 20, sku: 'ITM-000020', name: 'Cassava Dough',            base_unit: { id: 1, name: 'Kilogram', symbol: 'kg' } }, quantity: 0.10, unit: { id: 1, symbol: 'kg' } },
      { id: 26, item_id: 3,  item: { id: 3,  sku: 'ITM-000003', name: 'Tilapia (Fresh)',          base_unit: { id: 1, name: 'Kilogram', symbol: 'kg' } }, quantity: 0.60, unit: { id: 1, symbol: 'kg' } },
      { id: 27, item_id: 6,  item: { id: 6,  sku: 'ITM-000006', name: 'Tomatoes (Fresh)',         base_unit: { id: 1, name: 'Kilogram', symbol: 'kg' } }, quantity: 0.05, unit: { id: 1, symbol: 'kg' } },
      { id: 28, item_id: 16, item: { id: 16, sku: 'ITM-000016', name: 'Scotch Bonnet Pepper',     base_unit: { id: 1, name: 'Kilogram', symbol: 'kg' } }, quantity: 0.01, unit: { id: 1, symbol: 'kg' } },
      { id: 29, item_id: 27, item: { id: 27, sku: 'ITM-000027', name: 'Garlic',                   base_unit: { id: 1, name: 'Kilogram', symbol: 'kg' } }, quantity: 0.01, unit: { id: 1, symbol: 'kg' } },
      { id: 30, item_id: 28, item: { id: 28, sku: 'ITM-000028', name: 'Ginger (Fresh)',           base_unit: { id: 1, name: 'Kilogram', symbol: 'kg' } }, quantity: 0.01, unit: { id: 1, symbol: 'kg' } },
    ],
  },
  ...
  // ── Drumsticks (per 5 pieces) ─────────────────────────────────────────────
  {
    ...
    created_at: '2026-02-15T00:00:00Z', updated_at: '2026-03-01T00:00:00Z',
    ingredients: [
      { id: 31, item_id: 1,  item: { id: 1,  sku: 'ITM-000001', name: 'Chicken Thighs (Bone-in)', base_unit: { id: 1, name: 'Kilogram', symbol: 'kg' } }, quantity: 0.60, unit: { id: 1, symbol: 'kg' } },
      { id: 32, item_id: 11, item: { id: 11, sku: 'ITM-000011', name: 'Curry Powder',             base_unit: { id: 1, name: 'Kilogram', symbol: 'kg' } }, quantity: 0.005, unit: { id: 1, symbol: 'kg' } },
      { id: 33, item_id: 27, item: { id: 27, sku: 'ITM-000027', name: 'Garlic',                   base_unit: { id: 1, name: 'Kilogram', symbol: 'kg' } }, quantity: 0.008, unit: { id: 1, symbol: 'kg' } },
      { id: 34, item_id: 28, item: { id: 28, sku: 'ITM-000028', name: 'Ginger (Fresh)',           base_unit: { id: 1, name: 'Kilogram', symbol: 'kg' } }, quantity: 0.005, unit: { id: 1, symbol: 'kg' } },
      { id: 35, item_id: 10, item: { id: 10, sku: 'ITM-000010', name: 'Soyabean Oil',             base_unit: { id: 3, name: 'Litre', symbol: 'L'  } }, quantity: 1.00, unit: { id: 3, symbol: 'L'  } },
      { id: 36, item_id: 30, item: { id: 30, sku: 'ITM-000030', name: 'Seasoning Cubes (Maggi)',  base_unit: { id: 5, name: 'Piece', symbol: 'pc' } }, quantity: 2,    unit: { id: 5, symbol: 'pc' } },
    ],
  },
  ...
  // ── Rotisserie Grilled (half bird) ────────────────────────────────────────
  {
    ...
    created_at: '2026-02-15T00:00:00Z', updated_at: '2026-03-01T00:00:00Z',
    ingredients: [
      { id: 37, item_id: 32, item: { id: 32, sku: 'ITM-000032', name: 'Whole Chicken',            base_unit: { id: 5, name: 'Piece', symbol: 'pc' } }, quantity: 0.5, unit: { id: 5, symbol: 'pc' } },
      { id: 38, item_id: 27, item: { id: 27, sku: 'ITM-000027', name: 'Garlic',                   base_unit: { id: 1, name: 'Kilogram', symbol: 'kg' } }, quantity: 0.01, unit: { id: 1, symbol: 'kg' } },
      { id: 39, item_id: 28, item: { id: 28, sku: 'ITM-000028', name: 'Ginger (Fresh)',           base_unit: { id: 1, name: 'Kilogram', symbol: 'kg' } }, quantity: 0.01, unit: { id: 1, symbol: 'kg' } },
      { id: 40, item_id: 11, item: { id: 11, sku: 'ITM-000011', name: 'Curry Powder',             base_unit: { id: 1, name: 'Kilogram', symbol: 'kg' } }, quantity: 0.008, unit: { id: 1, symbol: 'kg' } },
      { id: 41, item_id: 30, item: { id: 30, sku: 'ITM-000030', name: 'Seasoning Cubes (Maggi)',  base_unit: { id: 5, name: 'Piece', symbol: 'pc' } }, quantity: 3,    unit: { id: 5, symbol: 'pc' } },
    ],
  },
  ...
  // ── Cedi Wraps (Chicken) ──────────────────────────────────────────────────
  {
    ...
    created_at: '2026-02-15T00:00:00Z', updated_at: '2026-03-01T00:00:00Z',
    ingredients: [
      { id: 42, item_id: 25, item: { id: 25, sku: 'ITM-000025', name: 'Flour Tortilla Wraps (10")',base_unit: { id: 6, name: 'Bag', symbol: 'bag' } }, quantity: 1, unit: { id: 5, symbol: 'pc' } },
      { id: 43, item_id: 2,  item: { id: 2,  sku: 'ITM-000002', name: 'Chicken Breast (Boneless)', base_unit: { id: 1, name: 'Kilogram', symbol: 'kg' } }, quantity: 0.12, unit: { id: 1, symbol: 'kg' } },
      { id: 44, item_id: 21, item: { id: 21, sku: 'ITM-000021', name: 'Cabbage (White)',            base_unit: { id: 1, name: 'Kilogram', symbol: 'kg' } }, quantity: 0.04, unit: { id: 1, symbol: 'kg' } },
      { id: 45, item_id: 22, item: { id: 22, sku: 'ITM-000022', name: 'Carrots',                    base_unit: { id: 1, name: 'Kilogram', symbol: 'kg' } }, quantity: 0.02, unit: { id: 1, symbol: 'kg' } },
      { id: 46, item_id: 24, item: { id: 24, sku: 'ITM-000024', name: 'Mayonnaise',                 base_unit: { id: 3, name: 'Litre', symbol: 'L'  } }, quantity: 0.025, unit: { id: 3, symbol: 'L'  } },
    ],
  },
];
