  ...
  hasMenu: {
    ...
    hasMenuSection: [
      ...
      },
      {
        ...
        hasMenuItem: [
          { '@type': 'MenuItem', name: 'Fried Rice + 3 pieces of Chicken', offers: { '@type': 'Offer', price: '90', priceCurrency: 'GHS' } },
          { '@type': 'MenuItem', name: 'Jollof Rice + 3 pieces of Chicken', offers: { '@type': 'Offer', price: '95', priceCurrency: 'GHS' } },
          { '@type': 'MenuItem', name: 'Assorted Fried Rice / Noodles + 3 pieces of Chicken', offers: { '@type': 'Offer', price: '110', priceCurrency: 'GHS' } },
          { '@type': 'MenuItem', name: 'Assorted Jollof Rice + 3 pieces of Chicken', offers: { '@type': 'Offer', price: '115', priceCurrency: 'GHS' } },
          { '@type': 'MenuItem', name: 'Fried Rice + 7 pieces of Chicken + Kɔkɔɔ', offers: { '@type': 'Offer', price: '145', priceCurrency: 'GHS' } },
          { '@type': 'MenuItem', name: 'Jollof Rice + 7 pieces of Chicken + Kɔkɔɔ', offers: { '@type': 'Offer', price: '150', priceCurrency: 'GHS' } },
          { '@type': 'MenuItem', name: 'Assorted Fried Rice / Noodles + 7 pieces of Chicken + Kɔkɔɔ', offers: { '@type': 'Offer', price: '165', priceCurrency: 'GHS' } },
          { '@type': 'MenuItem', name: 'Assorted Fried Rice / Noodles + Full Chicken + Kɔkɔɔ', offers: { '@type': 'Offer', price: '250', priceCurrency: 'GHS' } },
          { '@type': 'MenuItem', name: 'Assorted Jollof Rice + Full Chicken + Kɔkɔɔ', offers: { '@type': 'Offer', price: '255', priceCurrency: 'GHS' } },
        ],
      },
      {
        '@type': 'MenuSection',
