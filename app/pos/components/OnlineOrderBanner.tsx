...
export function OnlineOrderBanner() {
  ...
  return (
    <div
      role="status"
      aria-live="polite"
      className="fixed bottom-4 left-4 right-4 sm:right-auto sm:w-[24rem] z-[60] pos-arrival-in"
    >
      <div className="rounded-2xl bg-white border border-primary/40 shadow-xl shadow-black/10 overflow-hidden">
        {/* A coloured rail rather than a coloured card: the till is already a
            busy screen, and a full-bleed alert colour reads as an error. */}
        <div className="flex">
