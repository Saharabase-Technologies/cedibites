    ...
    <div className="md:px-8 py-6 max-w-4xl mx-auto">
      ...
      <div>
        <div className="flex items-center justify-between mb-3">
          ...
          <Link
            href="/staff/orders"
            className="text-text-brown dark:text-primary text-xs font-body hovertext-brown-light dark:hover:text-primary-hover transition-colors flex items-center gap-1"
          >
