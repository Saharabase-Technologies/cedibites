                    ...
                    orders.map((order, i) => (
                        <div key={order.id} onClick={() => setSelectedOrder(order)}
                            ...
                            <div className="flex flex-col">
                                ...
                                <span className="text-neutral-gray text-[10px] font-body">{order.paymentStatus === 'no_charge' ? 'Waived' : `Paid: ${formatGHS(Math.min(order.amountPaid, order.amount - order.deliveryFee))}`}</span>
                            </div>
